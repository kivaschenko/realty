    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agensy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='realtors', to='realtor.Agency', verbose_name='Агенство')),
